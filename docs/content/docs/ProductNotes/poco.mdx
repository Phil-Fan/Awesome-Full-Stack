...
里以我做的一个为了验证高德 MCP 能力做的「**早 C 晚 A**」概念的网站 [coffee.philfan.cn](https://coffee.philfan.cn) 为例
...
这个网站从 idea 到上线也只有半天的时间，所有代码开源在 [Phil-Fan/zju-coffee](https://github.com/Phil-Fan/zju-coffee) ，如果对这个有兴趣的同学可以提 PR 练练手。
...
- 线上体验地址 [philfan-poco.ms.show](https://philfan-poco.ms.show/zh/home) 。目前项目还处于比较早期的阶段，并没有上用户登录，所有对话都是所有用户可见的。
