...
在 [files.ettus.com/binaries/cache/x3xx](https://files.ettus.com/binaries/cache/x3xx/) 里面选择对应版本的 FPGA 镜像，直接下载，解压后采用非默认位置的烧录命令进行烧录，不过这种方法我还不知道怎么判断所需版本，我是试了两个就可以了。
